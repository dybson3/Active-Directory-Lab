...
3. [Installation of All Virtual Machines ⚙️](#3-installation-of-all-virtual-machines-)
4. [Setting Up Splunk Server and Sysmon 🔍](#4-setting-up-splunk-server-and-sysmon-)
5. [Installing and Configuring Active Directory 📜](#5-installing-and-configuring-active-directory-)
6. [Conducting a Brute Force Attack 🔓🔍](#6-conducting-a-brute-force-attack-)
7. [Installing Atomic Red Team 🧪](#7-installing-atomic-red-team-)
8. [Summary 📝](#summary-)
